...
for j in range(1,18):
    ...
    for fileName in filenames_torque:
        ...
        cols = ['time_prev_prev','time_prev','time',
                'knee_r_power_human_required'+col_add, 'knee_r_power_machine_required'+col_add, # 'knee_r_power'+col_add, 'knee_r_ang_vel'+col_add, 'knee_angle_r_moment'+col_add,
                'ankle_r_power_human_required'+col_add, 'ankle_r_power_machine_required'+col_add, # 'ankle_r_power'+col_add, 'ankle_r_ang_vel'+col_add, 'ankle_angle_r_moment'+col_add,
                'knee_l_power_human_required'+col_add, 'knee_l_power_machine_required'+col_add, # 'knee_l_power'+col_add, 'knee_l_ang_vel'+col_add, 'knee_angle_l_moment'+col_add,
                'ankle_l_power_human_required'+col_add, 'ankle_l_power_machine_required'+col_add, # 'ankle_l_power'+col_add, 'ankle_l_ang_vel'+col_add, 'ankle_angle_l_moment'+col_add,
                'Energy_At_Instance_Human_'+col_add,'Energy_At_Instance_Machine_'+col_add]
...
horizontal_stack_overall.to_csv("Energy_and_Power_based_on_threshold.csv", sep=',')