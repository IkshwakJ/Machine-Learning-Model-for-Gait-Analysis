...
threshold = 0.50 #This is the limit on the torque above which the system will provide the additional torque. It is in fraction.
...
horizontal_stack_overall.to_csv("Energy_and_Power_with_regen_based_on_threshold_50%.csv", sep=',')
