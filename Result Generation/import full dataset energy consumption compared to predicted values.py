...
for j in range(1,18):
    ...
    for fileName in filenames_torque:
        ...
        horizontal_stack['knee_r_power_predicted'+col_add] = 0.0174533*horizontal_stack['knee_r_moment_predicted'+col_add]*(horizontal_stack['knee_angle_r'+col_add] - horizontal_stack['knee_angle_r_prev'+col_add])/(horizontal_stack['time']-horizontal_stack['time_prev'])
        ...
        horizontal_stack['ankle_r_power_predicted'+col_add] = 0.0174533*horizontal_stack['ankle_r_moment_predicted'+col_add]*(horizontal_stack['ankle_angle_r'+col_add] - horizontal_stack['ankle_angle_r_prev'+col_add])/(horizontal_stack['time']-horizontal_stack['time_prev'])
        ...
        horizontal_stack['knee_l_power_predicted'+col_add] = 0.0174533*horizontal_stack['knee_l_moment_predicted'+col_add]*(horizontal_stack['knee_angle_l'+col_add] - horizontal_stack['knee_angle_l_prev'+col_add])/(horizontal_stack['time']-horizontal_stack['time_prev'])
        ...
        horizontal_stack['ankle_l_power_predicted'+col_add] = 0.0174533*horizontal_stack['ankle_l_moment_predicted'+col_add]*(horizontal_stack['ankle_angle_l'+col_add] - horizontal_stack['ankle_angle_l_prev'+col_add])/(horizontal_stack['time']-horizontal_stack['time_prev'])
        ...
        horizontal_stack['Energy_At_Instance_'+col_add] = (absolute(horizontal_stack['knee_r_energy'+col_add]) + absolute(horizontal_stack['ankle_r_energy'+col_add]) + 
                                                    absolute(horizontal_stack['knee_l_energy'+col_add]) + absolute(horizontal_stack['ankle_l_energy'+col_add]))
        horizontal_stack['Energy_At_Instance_Predicted_'+col_add] = (absolute(horizontal_stack['knee_r_energy_predicted'+col_add]) + absolute(horizontal_stack['ankle_r_energy_predicted'+col_add]) + 
                                                    absolute(horizontal_stack['knee_l_energy_predicted'+col_add]) + absolute(horizontal_stack['ankle_l_energy_predicted'+col_add]))                                  

        cols = ['time_prev_prev','time_prev','time','Energy_At_Instance_'+col_add,'Energy_At_Instance_Predicted_'+col_add]
        horizontal_stack = horizontal_stack.drop(horizontal_stack.columns.difference(cols), axis=1)
        horizontal_stack['Energy_Over_Time_'+col_add] = pd.Series(dtype='float')
        horizontal_stack['Energy_Over_Time_Predicted_'+col_add] = pd.Series(dtype='float')
        ...
        horizontal_stack['Energy_sum'+col_add][0] = horizontal_stack['Energy_At_Instance_'+col_add].sum()
        ...
        for p in range (horizontal_stack.shape[0]):
            if p==0:
                horizontal_stack['Energy_Over_Time_'+col_add][p] = horizontal_stack['Energy_At_Instance_'+col_add][0]
                horizontal_stack['Energy_Over_Time_Predicted_'+col_add][p] = horizontal_stack['Energy_At_Instance_Predicted_'+col_add][0]
            else:
                horizontal_stack['Energy_Over_Time_'+col_add][p] = horizontal_stack['Energy_Over_Time_'+col_add][p-1] + horizontal_stack['Energy_At_Instance_'+col_add][p] 
                horizontal_stack['Energy_Over_Time_Predicted_'+col_add][p] = horizontal_stack['Energy_Over_Time_Predicted_'+col_add][p-1] + horizontal_stack['Energy_At_Instance_Predicted_'+col_add][p] 
        # print(id_num)
        # print(first_timestamp)
        # print(horizontal_stack.describe)
        # horizontal_stack = horizontal_stack[cols]
...
horizontal_stack_overall.to_csv("Energy_comparison_data_overall.csv", sep=',')