...
threshold = 0.40 #This is the limit on the torque above which the system will provide the additional torque. It is in fraction.
...
horizontal_stack_overall.to_csv("Energy_and_Power_with_regen_based_on_threshold_40%.csv", sep=',')
