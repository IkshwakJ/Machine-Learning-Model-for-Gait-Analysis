...
for j in range(1,18):
    ...
    for fileName in filenames_torque:
        ...
        drop_list_new = ['time_prev_prev','time_prev','time','knee_angle_l_moment'+col_add,'knee_l_moment_predicted' + col_add]
...
horizontal_stack_overall.to_csv("Moment_data_overall_with_left_knee_moment_prediction.csv", sep=',')