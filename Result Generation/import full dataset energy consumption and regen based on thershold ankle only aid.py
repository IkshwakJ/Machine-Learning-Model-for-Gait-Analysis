...
motr_output_eff = 0.95 #This is the efficency of the motor in using electrical energy to provide output.
motor_regen_eff = 0.33 #This is the efficency of the motor in using kinetic energy to provide electrical output.
gear_train_eff = 0.8*0.9 #This is the efficiency of the geartrain that connects the motor to the joint.
...
for j in range(1,18):
    ...
    for fileName in filenames_torque:
        ...
        horizontal_stack['knee_r_power_human_required'+col_add] = 0
        horizontal_stack['knee_r_power_machine_required'+col_add] = 0
        horizontal_stack['ankle_r_power_human_required'+col_add] = 0
        horizontal_stack['ankle_r_power_machine_required'+col_add] = 0
        horizontal_stack['knee_l_power_human_required'+col_add] = 0
        horizontal_stack['knee_l_power_machine_required'+col_add] = 0
        horizontal_stack['ankle_l_power_human_required'+col_add] = 0
        horizontal_stack['ankle_l_power_machine_required'+col_add] = 0
        ...
        for r in range (horizontal_stack.shape[0]):
            ...
            if  horizontal_stack['ankle_l_power_machine_required'+col_add][r]<0:
                horizontal_stack['ankle_l_power_regen'+col_add][r] = horizontal_stack['ankle_l_power_machine_required'+col_add][r]
                horizontal_stack['ankle_l_power_machine_required'+col_add][r] = 0
        horizontal_stack['knee_r_power_machine_required'+col_add] = horizontal_stack['knee_r_power_machine_required'+col_add]/motr_output_eff
        horizontal_stack['knee_l_power_machine_required'+col_add] = horizontal_stack['knee_l_power_machine_required'+col_add]/motr_output_eff
        horizontal_stack['ankle_r_power_machine_required'+col_add] = horizontal_stack['ankle_r_power_machine_required'+col_add]/motr_output_eff
        horizontal_stack['ankle_l_power_machine_required'+col_add] = horizontal_stack['ankle_l_power_machine_required'+col_add]/motr_output_eff
...
horizontal_stack_overall.to_csv("Energy_and_Power_with_regen_based_on_threshold ankle aid.csv", sep=',')
