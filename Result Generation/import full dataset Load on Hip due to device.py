...
for j in range(1,18):
    ...
    for fileName in filenames_torque:
        ...
        drop_list = ['time_prev_prev','time_prev','time', 
                    # 'Energy_Device_Inst_Hip_R'+col_add, 'Energy_Device_Inst_Hip_L'+col_add, 
                    'Energy_Device_Used_Hip_R'+col_add,'Energy_Device_Used_Hip_L'+col_add,
                    # 'Energy_Device_Regen_Hip_R'+col_add, 'Energy_Device_Regen_Hip_L'+col_add,
        ...
        Total_Used_Power = Total_Used_Power + (horizontal_stack['Energy_Device_Used_Hip_R'+col_add][horizontal_stack.shape[0]-1]+horizontal_stack['Energy_Device_Used_Hip_L'+col_add][horizontal_stack.shape[0]-1])/horizontal_stack['time'][horizontal_stack.shape[0]-1]
...
print("Total Additional Load on Hip (Average): ", Total_Used_Power)
