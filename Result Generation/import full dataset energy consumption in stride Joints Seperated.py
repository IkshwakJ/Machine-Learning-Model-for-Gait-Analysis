...
for j in range(1,18):
    ...
    for fileName in filenames_torque:
        ...
        cols = ['time_prev_prev','time_prev','time','hip_r_energy'+col_add,'knee_r_energy'+col_add,'ankle_r_energy'+col_add,'hip_l_energy'+col_add,'knee_l_energy'+col_add,'ankle_l_energy'+col_add]
...
horizontal_stack_overall.to_csv("Energy_Joints_data_overall.csv", sep=',')