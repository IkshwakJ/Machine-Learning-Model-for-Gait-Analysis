...
predictors.remove('knee_angle_r^3')
predictors.remove('knee_angle_r^4')
predictors.remove('knee_angle_r^5')
predictors.remove('ankle_angle_r^3')
predictors.remove('ankle_angle_r^4')
predictors.remove('ankle_angle_r^5')
predictors.remove('knee_angle_l^3')
predictors.remove('knee_angle_l^4')
predictors.remove('knee_angle_l^5')
predictors.remove('ankle_angle_l^3')
predictors.remove('ankle_angle_l^4')
predictors.remove('ankle_angle_l^5')
