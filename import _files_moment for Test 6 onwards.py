...
Added_entry_labels = [x + '_prev' for x in file_labels_overall]
file_labels_overall = zip(Added_entry_labels, file_labels_overall)
file_labels_overall = list(chain.from_iterable(file_labels_overall))
df_angles.columns = file_labels_overall
drop_list = ["time_prev","knee_angle_r_prev","knee_angle_r","ankle_angle_r_prev","ankle_angle_r","knee_angle_l_prev","knee_angle_l","ankle_angle_l_prev","ankle_angle_l"]
...
horizontal_stack.to_csv("Moment_data_new_test.csv", sep=',')